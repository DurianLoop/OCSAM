<h1 align="center">OCSAM Medical Segmentation Workspace</h1>
...
```text
D:\SAM
├── code      # main OCSAM code repository
├── Matcher   # clean upstream Matcher reference clone
├── assets    # shared checkpoints, not committed
├── docs      # papers and workspace notes
└── conda_envs
```
...
Important local artifacts are intentionally not committed: checkpoints, medical datasets, conda environments, and generated outputs.

For the medical reproduction guide, see:

- `docs/workspace_guide.md`
- `docs/paper_code_map.md`

The original Matcher README is preserved below for upstream context.
